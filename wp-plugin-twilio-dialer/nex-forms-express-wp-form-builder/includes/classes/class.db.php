...
add_action('wp_ajax_nf_hidden_fields', array('NEXForms_Database_Actions','get_form_hidden_fields'));
...
add_action('wp_ajax_get_c_logic_ui', array('NEXForms_Database_Actions','get_c_logic_ui'));
