...
function NEXForms_test_page(){
	...
	/*global $wpdb;
			//if($form_id!=0)
			$result = $wpdb->get_row('SELECT * FROM '.$wpdb->prefix.'wap_nex_forms WHERE Id=218');

		echo '<pre>';
			print_r(json_decode(strip_tags($result->multistep_settings)));
		echo '</pre>';	*/
...
/* UI SCRIPT REGISTRATION */
	...
	wp_register_script('nex-forms-locales.min', plugins_url( '/libs/locales.min.js',__FILE__),'',$css_js_version);
